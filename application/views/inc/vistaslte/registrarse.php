...
<html class="loading" lang="en" data-textdirection="ltr">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>admin/app-assets/css/pages/account-register.css">
    <!-- END Page Level CSS-->
    <!-- BEGIN Custom CSS-->
  ...
  <body class="vertical-layout vertical-compact-menu 1-column  bg-full-screen-image menu-expanded blank-page blank-page" data-open="click" data-menu="vertical-compact-menu" data-col="1-column">
                            ...
                            <div class="form-group row">
                                <div class="col-12 text-center text-sm-left">
                                    <fieldset>
                                        ...
                                        <label for="remember-me"> Acepto los terminos y condiciones</label>
                                    </fieldset>
                                </div>                                
                            </div>
                            <button type="submit" class="btn-gradient-primary btn-block my-1">Sign Up</button>
                            <p class="text-center"><a href="<?php echo base_url(); ?>index.php/login/index" class="card-link">Log In</a></p>
                            <?php
                        echo form_close();
                        ?>
    ...
    <!-- END PAGE VENDOR JS-->
    <!-- BEGIN MODERN JS-->
    <script src="<?php echo base_url(); ?>admin/app-assets/js/core/app-menu.js" type="text/javascript"></script>
