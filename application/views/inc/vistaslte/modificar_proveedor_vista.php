                        ...
                        <div class="row">
                            ...
                            ?>
                                ...
                                ?>
                                    ...
                                    <div class="col-6">
                                        <fieldset class="form-label-group">
                                            <input type="text" class="form-control" name="encargado" value="<?php echo $row->encargado; ?>"  required>
                                            <label for="last-name">Persona encargada</label>
                                        </fieldset>
                                    </div>
                                    <div class="col-6">
                                        <fieldset class="form-label-group">
                                            <input type="text" class="form-control" name="contacto" maxlength="8" value="<?php echo $row->contacto; ?>" required>
