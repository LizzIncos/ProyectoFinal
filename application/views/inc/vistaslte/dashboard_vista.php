      ...
      <div class="content-wrapper">
        <div class="content-header row">
          <div class="content-header-left col-md-8 col-12 mb-2 breadcrumb-new">
            <h3 class="content-header-title mb-0 d-inline-block">Inicio</h3>
        ...
        <div class="content-detached content-center">
                    ...
                    <div class="row">
                        <div class="col-lg-9">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row d-flex justify-content-center">
                                                <div class="col-9">
                                                    <p class="text-dark mb-0 fw-semibold">Total Proveedores</p>
                                                    <h3 class="my-1 font-20 fw-bold" href="<?php echo base_url(); ?>index.php/proveedor/agregar">24k</h3>
                                ...
                                <div class="col-md-6 col-lg-3">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row d-flex justify-content-center">                                                
                                                <div class="col-9">
                                                    <p class="text-dark mb-0 fw-semibold">Total Categorias</p>
                                ...
                                <div class="col-md-6 col-lg-3">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row d-flex justify-content-center">                                                
                                                <div class="col-9">
                                                    <p class="text-dark mb-0 fw-semibold">Total Productos</p>
                                ...
                                <div class="col-md-6 col-lg-3">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row d-flex justify-content-center">
                                                <div class="col-9">  
                                                    <p class="text-dark mb-0 fw-semibold">Total Pedidos</p>                                         
                            ...
                            <?php
                                echo form_open_multipart("dashboard/index1");
                            ?>
                            <div class="card">
                                <div class="card-header">
                                    <div class="row align-items-center">
                                        <div class="col">                      
                                            <h4 class="card-title">Entradas y Pedidos de Productos</h4>                      
                                        </div><!--end col-->
                                        <div class="col-auto"> 
                                            <div class="dropdown">
