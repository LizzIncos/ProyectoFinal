      ...
      <div class="content-wrapper">
        <div class="content-header row">
          ...
          <div class="content-header-right col-md-2 col-12 d-none d-md-inline-block">
            <?php echo form_open_multipart('pedido/menu'); ?>
              <button type="button" class="btn-gradient-secondary btn-sm white" data-toggle="modal" data-target="#purchaseBTCModalLabel">Solicitar pedido</button>
            <?php echo form_close(); ?>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row['inventarioRecibido']; ?></td>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="purchaseModalLabel">Solicitar Pedido</h5>
            ...
            <div class="modal-body">
                ...
                <?php
                echo form_open_multipart("pedido/inscribirbd");
                ?>
                <form class="form form-horizontal mt-2 mx-2">
                    <div class="form-body">
                        <div class="row">
                            <div class="col-12 col-md-5">
                                <div class="form-group row">
                                    <label class="col-2 label-control" for="projectinput1">Producto</label>
                                    <fieldset class="col-10">
                                      <div class="input-group">
                                       
                                        <select name="idproducto" class="form-control form-select form-select-lg" required>
                                            <option value="" disabled selected>Seleccione un producto</option>
                                            <?php
                                            foreach ($infoproductos as $row) {
                                            ?>
                            ...
                            <div class="col-12 col-md-5">
                                <div class="form-group row">
                                    <label class="col-2 label-control" for="projectinput2">Categoria</label>
                                    <fieldset class="col-10">
                                      <div class="input-group">
                                        <input type="text" name="categoria" class="form-control" value="" aria-describedby="basic-addon4">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-5">
                                <div class="form-group row">
                                    <label class="col-2 label-control" for="projectinput1">Cantidad</label>
                                    <fieldset class="col-10">
                                      <div class="input-group">
                                        <input type="text" name="cantidad" class="form-control" value="" aria-describedby="basic-addon4">
                                        <div class="input-group-append">
                            ...
                            <div class="col-12 col-md-5">
                                <div class="form-group row">
                                    <label class="col-2 label-control" for="projectinput2">Fecha Pedido</label>
                                    <fieldset class="col-10">
                                      <div class="input-group">
                                        <input type="date" name="fechaPedido" class="form-control" value="" aria-describedby="basic-addon4">
                                        <div class="input-group-append">
                                          <span class="input-group-text" id="basic-addon4"><i class="icon-layers"></i></span>
                                        </div>
                                      </div>
                        ...
                        <button type="submit" class="btn-gradient-primary btn-block my-1">Solicitar Pedido</button>
