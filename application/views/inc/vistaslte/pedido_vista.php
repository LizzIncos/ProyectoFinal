      ...
      <div class="content-wrapper">
        <div class="content-header row">
          <div class="content-header-left col-md-8 col-12 mb-2 breadcrumb-new">
            <h3 class="content-header-title mb-0 d-inline-block">Pedidos</h3>
          ...
          <div class="content-header-right col-md-4 col-12 d-none d-md-inline-block">
            <div class="btn-group float-md-right"><a class="btn-gradient-secondary btn-sm white" href="<?php echo base_url(); ?>index.php/pedido/demo">Registrar Pedido</a></div>
                                        ...
                                        <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                <div style="display: flex; align-items: center;">
                                                    <?php
                                                    echo form_open_multipart("pedido/modificar");
                                                    ?>
                                                    ...
                                                    ?>	
                                                    <?php
                                                    echo form_open_multipart("pedido/eliminarbd");
                                                    ?>
                                                        <input type="hidden" name="idpedido" value="<?php echo $row->idpedido; ?>">
