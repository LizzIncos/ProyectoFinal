            ...
            <div class="row breadcrumbs-top d-inline-block">
              <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active">Modificar producto
                  </li>
                </ol>
              </div>
            </div>
                            ...
                            <div class="col-md-10 col-12">
                                <div class="row">
                                    <div class="col-12 col-md-4">
                                        <p class="text-bold-700 text-uppercase mb-0">Modificar Producto</p>
                                        <p class="mb-0"></p>
                                    </div>
                                    <div class="col-12 col-md-4">
                                ...
                                <form class="form-horizontal form-user-profile row mt-2" action="index.html">
                                    ...
                                    <div class="col-12">
                                        <fieldset class="form-label-group">
                                            <input type="text" class="form-control" name="producto" value="<?php echo $row->producto; ?>" required autofocus="">
                                            <label for="first-name">Producto</label>
                                        </fieldset>
                                    </div>
                                    <div class="col-12">
                                        <fieldset class="form-label-group">
                                            <input type="text" class="form-control" name="categoria" value="<?php echo $row->categoria; ?>" required autofocus="">
                                            <label for="last-name">Categoria</label>
                                        </fieldset>
                                    </div>
                                    <div class="col-6">
                                        <fieldset class="form-label-group">
                                            <input type="number" class="form-control" name="cantidad" value="<?php echo $row->cantidad; ?>" required autofocus="">
                                            <label for="user-name">Cantidad</label>
                                        </fieldset>
                                    </div>
                                    <div class="col-6">
                                        <fieldset class="form-label-group">
                                            <input type="date" class="form-control" name="fecha" vvalue="<?php echo $row->fecha; ?>" required autofocus="">
                                            <label for="email-address">Fecha Registro</label>
                                        </fieldset>
                                    </div>
                                    
                                    <div class="col-12 text-right">
                                        <button type="submit" class="btn-gradient-primary my-1">Modificar Producto</button>
                                    </div>
                                </form>
                                <?php
                                echo form_close();
