            ...
            <ul class="nav navbar-nav mr-auto float-left">
              ...
              <li class="nav-item nav-search"><a class="nav-link nav-link-search" href="#"><i class="ficon ft-search"></i></a>
                <div class="search-input">
                  <input class="input" type="text" placeholder="Explora Vision Stock...">
                </div>
              </li>
            </ul>
    ...
    <div class="main-menu menu-fixed menu-dark menu-bg-default rounded menu-accordion menu-shadow">
      <div class="main-menu-content"><a class="navigation-brand d-none d-md-block d-lg-block d-xl-block" href="index.html"><img class="brand-logo" alt="CryptoDash admin logo" src="../../../app-assets/images/logo/logo.png"/></a>
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          ...
          <li class=" nav-item"><a href="<?php echo base_url(); ?>index.php/proveedor/menu"><i class="icon-wallet"></i><span class="menu-title" data-i18n="">Proveedores</span></a>
          </li>
          <li class=" nav-item"><a href="<?php echo base_url(); ?>index.php/inventario/index"><i class="icon-shuffle"></i><span class="menu-title" data-i18n="">Inventario</span></a>
          </li>
          
          <li class=" nav-item"><a href="#"><i class="icon-user-following"></i><span class="menu-title" data-i18n="">Usuarios</span></a>
            <ul class="menu-content">
              <li><a class="menu-item" href="<?php echo base_url(); ?>index.php/usuario/index">Usuarios</a>
              </li>
              <li><a class="menu-item" href="account-login-history.html">Permisos</a>
              </li>
              ...
              <li><a class="menu-item" href="#">Misc</a>
                <ul class="menu-content">
                  ...
                  <li><a class="menu-item" href="account-register.html">Registrar Usuario</a>
                  </li>
                </ul>
              </li>
            </ul>
